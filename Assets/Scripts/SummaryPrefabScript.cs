...
//    public void UpdateDataFromStats(DailyStats stats)
//    {
//        UpdateData(
//            stats.dayNumber,
//            stats.numberOfCustomers,
...
//            stats.highestTransactionValue,
//            stats.mostProfitableCustomer,
//            stats.dailyProfit, // Assuming this is the total amount
//            stats.mostProfitableTransactionProfit,
//            stats.dailyProfit,
//            stats.customerSatisfaction,
//            // Assuming these methods or properties are available
//            customersNotSatisfied,
//            itemsNotSatisfied,
//            stats.dailyRevenue,
//            stats.dailyExpenses
...
//        int maxCount = 0;
//        string mostPopular = "N/A";
//        for (int i = 0; i < stats.itemCounts.Count; i++)
//        {
//            if (stats.itemCounts[i] > maxCount)
//            {
//                maxCount = stats.itemCounts[i];
//                mostPopular = stats.itemNames[i];
//            }
//        }
//        return mostPopular;
//    }
...
//        for (int i = 0; i < stats.itemCounts.Count; i++)
//        {
//            if (stats.itemCounts[i] < minCount)
//            {
//                minCount = stats.itemCounts[i];
//                leastPopular = stats.itemNames[i];
//            }
//        }
//        return leastPopular;
//    }
...
//    // Getter methods to ensure no errors in DailySummaryManager when calling these properties
//    public int GetNumberOfCustomers() => int.Parse(numOfCustomersNum.text);
//    public float GetDailyRevenue() => float.Parse(dailyRevenue.text.Replace("£", ""));
//    public float GetDailyExpenses() => float.Parse(dailyExpenses.text.Replace("£", ""));
//    public float GetDailyProfit() => float.Parse(dailyProfit.text.Replace("£", ""));
